...
export interface ImageOutputWidgetProps {
  src?: string
  onJump: (key: string) => void
}

const ImageOutputWidget = (props: ImageOutputWidgetProps) => {
  const { src, onJump } = props

  const urlValid = src !== undefined
...
export default ImageOutputWidget
