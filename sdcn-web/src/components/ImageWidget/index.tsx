...
const ImageWidget = (props: any) => {
  ...
  const urlValid = (props.src !== undefined);
  
  return (
    <div className={cx(styles.wrap + 'w-full flex justify-center items-center')} style={{height: '788px'}}> 
      {
        urlValid ? 
          <Image src={props.src} 
              placeholder={true} fallback={fallbackImageURL}/>
          : 
          <Title style={{color: 'rgba(0,0,0,0.25)'}} 
            level={2} >Images you generated will be shown here</Title>
      }
      <GeneratingMask open={props.loading} />
    </div>
  );
}
